#importing the tkinter library for various inbuilt buttons and lables.
from tkinter import *
...
class user:
    ...
    def login(self):
        ...
        if result:
            ...
            self.head['text'] = "Welcome to LPG Booking System, " + self.username.get()
    ...
    #Draw Widgets
    def widgets(self):
        self.head = Label(self.master,text = 'LOGIN',font = ('',35),pady = 10,bg="khaki")
        self.head.pack(fill=X)
        self.logf = Frame(self.master,padx =10,pady = 10,bg="khaki")
        Label(self.logf,text = 'Username: ',font = ('',20),pady=5,padx=5,bg="khaki").grid(sticky = W)
        Entry(self.logf,textvariable = self.username,bd = 5,font = ('',15)).grid(row=0,column=1)
        Label(self.logf,text = 'Password: ',font = ('',20),pady=5,padx=5,bg="khaki").grid(sticky = W)
        ...
        self.crf = Frame(self.master,padx =10,pady = 10,bg="khaki")
        Label(self.crf,text = 'Username: ',font = ('',20),pady=5,padx=5,bg="khaki").grid(sticky = W)
        Entry(self.crf,textvariable = self.n_username,bd = 5,font = ('',15)).grid(row=0,column=1)
        Label(self.crf,text = 'Password: ',font = ('',20),pady=5,padx=5,bg="khaki").grid(sticky = W)
        Entry(self.crf,textvariable = self.n_password,bd = 5,font = ('',15),show = '*').grid(row=1,column=1)
        Button(self.crf,text = 'Create Account',bd = 3 ,font = ('',15),padx=5,pady=5,bg="khaki",command=self.new_user).grid()
...
class travel:
    ...
    def __init__(self,root):
        self.root = root
        self.root.title("New to LPG Connection and Booking System")
   ...
   #================================================mainframe========================================================================
        ...
        Tops = Frame(MainFrame, bd=20, width=1350,relief=SUNKEN, bg="khaki")
        Tops.pack(side=TOP,fill=BOTH)
      
        self.lblTitle=Label(Tops,font=('arial',50,'bold'),text="Book your LPG:", fg="red",bg="khaki")
        self.lblTitle.grid()

    #================================================customerframedetail=============================================================
        CustomerDetailsFrame=LabelFrame(MainFrame, width=1350,height=500,bd=20, pady=5, relief=RIDGE,bg="khaki")
        CustomerDetailsFrame.pack(side=BOTTOM,fill=BOTH,expand=True)

        FrameDetails=Frame(CustomerDetailsFrame, width=880,height=400,bd=10, relief=RIDGE,bg="khaki")
        FrameDetails.pack(side=LEFT,fill=BOTH,expand=True)

        CustomerName=LabelFrame(FrameDetails, width=150,height=250,bd=10, font=('arial',12,'bold'),text="Customer's Details:", relief=RIDGE,bg="khaki")
        CustomerName.grid(row=0,column=0)

        TravelFrame = LabelFrame(FrameDetails,bd=10, width=300,height=250, font=('arial',12,'bold'),text="Booking Details:", relief=RIDGE,bg="khaki")
        TravelFrame.grid(row=0,column=1)

        Book_Frame=LabelFrame(FrameDetails,width=300,height=150,relief=FLAT,bg="khaki")
        Book_Frame.grid(row=1,column=0)

        CostFrame = LabelFrame(FrameDetails,width=150,height=150,bd=5,relief=FLAT,bg="khaki")
    ...
    #=========================================================CustomerName====================================================
        ...
        self.lblFirstname=Label(CustomerName,font=('arial',14,'bold'),text="First Name",bd=7,bg="khaki")
        ...
        self.lblSurname=Label(CustomerName,font=('arial',14,'bold'),text="Sirname",bd=7,bg="khaki")
        ...
        self.lblAddress=Label(CustomerName,font=('arial',14,'bold'),text="Address",bd=7,bg="khaki")
        ...
        self.lblPincode=Label(CustomerName,font=('arial',14,'bold'),text="Pin Code",bd=7,bg="khaki")
        ...
        self.lblTelephone=Label(CustomerName,font=('arial',14,'bold'),text="Telephone No.",bd=7,bg="khaki")
        ...
        self.lblMobile=Label(CustomerName,font=('arial',14,'bold'),text="Mobile No.",bd=7,bg="khaki")
        ...
        self.lblEmail=Label(CustomerName,font=('arial',14,'bold'),text="Email ID:",bd=7,bg="khaki")
    ...
    #===============================================LPG Information==============================================================
        self.lblDelPlace=Label(TravelFrame,font=('arial',14,'bold'),text="Delivery Place",bd=7,bg="khaki")
        ...
        self.lblType=Label(TravelFrame,font=('arial',14,'bold'),text="LPG Cylinder type",bd=7,bg="khaki")
        ...
        self.lblNoCyn=Label(TravelFrame,font=('arial',14,'bold'),text="No. of Cylinder",bd=7,bg="khaki")
    ...
    #===============================================Charging Information==============================================================
        ...
        self.chkMainCost=Checkbutton(TravelFrame,text=" Main Cost*",bg="khaki",variable = var1, onvalue=1, offvalue=0,font=('arial',16,'bold'),command=Main_Cost).grid(row=4, column=0, sticky=W)
        ...
        self.chkKm=Checkbutton(TravelFrame,text="Delivery Charges (KMs)*",bg="khaki",variable = var2, onvalue=1, offvalue=0,font=('arial',16,'bold'),command=Kilo).grid(row=5, column=0, sticky=W)
        ...
        self.chkSeq_Money=Checkbutton(TravelFrame,text="Security Money *",bg="khaki",variable = var3, onvalue=1, offvalue=0,font=('arial',16,'bold'),command=SeqMoney).grid(row=6, column=0, sticky=W)
        ...
        self.chkLuggage=Checkbutton(TravelFrame,text="Redeem Discount/ Luggage Amount",bg="khaki",variable = var4, onvalue=1, offvalue=0,font=('arial',16,'bold'),command=Lug).grid(row=7, column=0, sticky=W)
    ...
    #=================================payment information ===========================================================================
        ...
        self.lblPaidTax=Label(CostFrame,font=('arial',14,'bold'),text="Paid Tax\t\t",bd=7,bg="khaki")
        ...
        self.lblSubTotal=Label(CostFrame,font=('arial',14,'bold'),text="Sub Total",bd=7,bg="khaki")
        ...
        self.lblTotalCost=Label(CostFrame,font=('arial',14,'bold'),text="Total Cost",bd=7,bg="khaki")
    ...
    #==========================================================Cylinder Select=======================================================================
        ...
        self.chkDomestic=Radiobutton(Book_Frame,text="Domestic  ",value=1,variable = cynType,font=('arial',14,'bold'),bg="khaki",command=selectCyn).grid(row=0, column=0, sticky=W)
        ...
        self.chkCommertial=Radiobutton(Book_Frame,text="Commertial",value=2,variable = cynType,font=('arial',14,'bold'),bg="khaki",command=selectCyn).grid(row=1, column=0, sticky=W)
        ...
        self.chkPipeline = Radiobutton(Book_Frame,text="Pipeline     ",value=3,variable = cynType,font=('arial',14,'bold'),bg="khaki",command=selectCyn).grid(row=2, column=0)
        ...
        self.chkTDays =Radiobutton(Book_Frame,text="Time Period: 20 Days",bg="khaki",value=1,variable = timeType,font=('arial',14,'bold')).grid(row=0, column=2, sticky=W)
        self.chkOMth =Radiobutton(Book_Frame,text="Time Period: 1 Month",bg="khaki",value=2,variable = timeType,font=('arial',14,'bold')).grid(row=1, column=2, sticky=W)
        self.chkOFMths =Radiobutton(Book_Frame,text="Time Period: 1.5 Months",bg="khaki",value=3,variable = timeType,font=('arial',14,'bold')).grid(row=2, column=2, sticky=W)
    ...
    #------------------------------------Button1--------------------------------------------------------------------------------------
        self.btnBook = Button(Button1Frame,padx=14,bd=5,font=('arial',12,'bold'),width = 20,bg="khaki", fg ="red", text='BOOK YOUR LPG', command=iBook).grid()
        self.btnNew = Button(Button1Frame,padx=14,bd=5,font=('arial',12,'bold'),width = 20,bg="khaki", fg ="red", text='NEW LPG CONNECTION', command=profile).grid()
